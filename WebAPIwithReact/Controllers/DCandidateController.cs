...
namespace WebAPIwithReact.Controllers
{
    ...
    public class DCandidateController : ControllerBase
    {
        ...
        // need to do any operation inside the database
        //get from the dependency injection (instance of a context)
        ...
        // GET: api/DCandidate
        // get all of the records of our table
        [HttpGet]
